...
from src.Nas.Layers.Pytorch import ChooseNParallel

from src.Nas.Layers.Pytorch.Common import Dyn_Conv2D, GlobalAveragePooling, LogSoftMax, Id
from src.Nas.Utils import calcNumLayers, random_one_hot_like, weight_softmax
from src.Nas.Networks.Pytorch.SearchModule import InferenceType

from src.Nas.Layers.Pytorch import Sequential, Parallel_Choice_Add, ChooseNParallel_v2, MakeChoice
...
class SearchNet(nn.Module):
    def __init__(self, input_dims, num_classes) -> None:
        ...
        self._t = 1
        # self._layers = []
        self._num_red_time = calcNumLayers(input_dims[0], 2, Config.dim_limit_time)
