...
from src.Nas.Utils import AvgrageMeter, accuracy
    ...
    def train(self, train_queue, valid_queue, num_epochs, target_lat, target_mem, callback=None, epochs_pretrain=0, num_arch_train_steps=1, eps_decay=0.995, alpha_lat=1, alpha_mem=1):
        ...
        for epoch in range(num_epochs):
            ...
            for step, (input_time, input_freq, target) in enumerate(pbar := tqdm(train_queue)):
                ...
                prec1, prec3 = accuracy(logits, target, topk=(1, 3))
            ...
            print('Step: %03d, Obj_avg: %e, Top1_avg: %f, Top3_avg: %f' %
                  (step, objs.avg, top1.avg, top3.avg))
