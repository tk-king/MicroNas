...
class ConvBlock(nn.Module):
    ...
    def __init__(self, filter_width, input_filters, nb_filters, dilation, batch_norm):
        ...
        self.conv1 = nn.Conv2d(self.input_filters, self.nb_filters, (self.filter_width, 1), dilation=(self.dilation, 1),stride=(1,1))
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(self.nb_filters, self.nb_filters, (self.filter_width, 1), dilation=(self.dilation, 1), stride=(1,1))
        if self.batch_norm:
