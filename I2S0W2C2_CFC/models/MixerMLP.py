...
class TokenMixer(nn.Module):
    def __init__(self, num_features, segments_nr, sensor_channel, expansion_factor, dropout, residual_flag):
        super().__init__()
...
class MixerLayer(nn.Module):
    def __init__(self, num_features, segments_nr, sensor_channel, expansion_factor, dropout, residual_flag):
        ...
        self.token_mixer = TokenMixer(
            num_features, segments_nr, sensor_channel, expansion_factor, dropout,residual_flag
        )
...
class FFTMIXER_HAR_Model(nn.Module):
  def __init__(
    ...
    self.mixer_layer = nn.Sequential(
            *[
                MixerLayer(filter_num*2, self.nr_segment, self.sensor_channel_nr, expansion_factor=expansion_factor, dropout=0, residual_flag= residual_flag)
