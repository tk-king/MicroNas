...
from .dataloader_GESTURE_har import GESTURE_HAR_DATA
from .dataloader_SENSED_har import SENSED_GESTURE_DATA
from .dataloader_LanguageSign_har import LANGUAGE_GESTURE_DATA
from .dataloader_LanguageSignIMU_har import LANGUAGEIMU_GESTURE_DATA
from .dataloader_LanguageSignPIZO_har import LANGUAGEPIZO_GESTURE_DATA
from .dataloader_GesHome_har import GESHOME_GESTURE_DATA
from .dataloader_EEGGesture import EEG_GESTURE_DATA
from .dataloader_EMGGesture import EMG_GESTURE_DATA
from .dataloader_MAGBreathing import MAG_Breathing_DATA
from .dataloader_imagery import Imagery_DATA
from .dataloader_BCIIA import BCIIA_DATA
from .dataloader_Jubot_har import Jubot_DATA
from .dataloader_MotionSense_har import MotionSense_HAR_DATA
from .dataloader_MHealth_har import Mhealth_HAR_DATA
# from .dataloader_EyeWALLE_har import EyeWALLE_DATA
# from .dataloader_EyeWALLW_har import EyeWALLW_DATA
# from .dataloader_EyeWALL_har import EyeWALL_DATA
data_dict = {"hapt"  : HAPT_HAR_DATA,
             ...
             "gesture": GESTURE_HAR_DATA,
             "sensed" : SENSED_GESTURE_DATA,
             "lsign" :  LANGUAGE_GESTURE_DATA,
             "lsignimu": LANGUAGEIMU_GESTURE_DATA,
             "lsignpizo":LANGUAGEPIZO_GESTURE_DATA,
             "geshome" : GESHOME_GESTURE_DATA,
             "eeggesture": EEG_GESTURE_DATA,
             "emggesture": EMG_GESTURE_DATA,
             "magbreathair":MAG_Breathing_DATA,
             "imagery":Imagery_DATA,
             "bciia":BCIIA_DATA,
             "jubot":Jubot_DATA,
             "motionsense":MotionSense_HAR_DATA,
             "mhealth":Mhealth_HAR_DATA,
             # "eyewall":EyeWALL_DATA,
             # "eyew":EyeWALLW_DATA,
             # "eye":EyeWALLE_DATA,
            }
